...
//But what if we didn't always need the family tree for a particular person? If we add the lazy keyword to the familyTree property, then Swift will only creat the FamilyTree struct it's first accessed👇
//lazy var familyTree = FamilyTree()
